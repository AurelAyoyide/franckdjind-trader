...
export function ResetPasswordForm({ token }: { token: string }) {
  ...
  return (
    <form action={formAction} className="max-w-2xl rounded-lg border border-line bg-surface p-6">
      ...
      <h2 className="text-2xl font-black">Choisir un nouveau mot de passe</h2>
      <p className="mt-3 text-sm leading-7 text-muted">Utilise au moins 8 caracteres, avec une lettre et un chiffre.</p>
      <PasswordField
