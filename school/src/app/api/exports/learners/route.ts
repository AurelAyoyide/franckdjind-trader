...
import { bufferToArrayBuffer, createLearnersWorkbook } from "@/lib/excel";
...
export async function GET(request: NextRequest) {
  ...
  return new Response(bufferToArrayBuffer(workbook), {
    headers: {
      ...
      "Content-Disposition": 'attachment; filename="school-apprenants.xlsx"',
    },
  });
}
