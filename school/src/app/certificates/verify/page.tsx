  ...
  return (
    <>
      <PageHero
        ...
        title={t("Vérifier une preuve de fin de formation.")}
        description={t("La vérification publique confirme le code du certificat sans ouvrir l'espace privé de l'apprenant.")}
      />
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="rounded-lg border border-line bg-surface p-6">
            ...
            <div className="mt-5 grid gap-3 text-sm font-semibold text-muted">
              ...
              <p className="rounded-lg border border-line bg-foreground/[0.04] p-3">{t("La formation associée.")}</p>
              <p className="rounded-lg border border-line bg-foreground/[0.04] p-3">{t("La date d'émission.")}</p>
            </div>
          </div>
        </div>
      </section>
